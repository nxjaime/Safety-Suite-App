...
- Sprint 61 still needs mutation-path QA for creating inspections with violations, remediation task/work-order creation, offline inspection queue/sync, compliance exports/filters, and driver-role completion/attestation with driver credentials.
