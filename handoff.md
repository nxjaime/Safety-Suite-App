...
- Sprint 61 still needs mutation-path QA for offline inspection queue/sync, compliance exports/filters, and driver-role completion/attestation with driver credentials.
